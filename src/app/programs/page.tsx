    ...
    return (
        <div className="flex flex-col min-h-screen bg-background-dark text-white font-sans">
            ...
            <main className="flex flex-col items-center w-full">
                {/* Hero Section */}
                <section className="w-full px-4 lg:px-40 py-10 lg:py-16 bg-surface-dark">
                        ...
                        <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center">
                            <div className="flex flex-col gap-6 lg:w-1/2">
                                ...
                                <div className="flex gap-4 pt-2">
                                    ...
                                    <button className="flex items-center justify-center rounded-lg h-12 px-6 bg-transparent border border-white/20 text-white text-base font-bold leading-normal hover:bg-white/5 transition-all">
                                        How We Deliver
                                    </button>
                                </div>
                            </div>
                ...
                {/* Program Themes Grid */}
                <section className="w-full px-4 lg:px-40 py-16 bg-background-dark">
                    <div className="max-w-[1280px] w-full mx-auto">
                        <div className="flex flex-col mb-10 text-center lg:text-left">
                            <h2 className="text-white text-[32px] font-bold leading-tight tracking-tight">Key Program Themes</h2>
                            <p className="text-gray-400 mt-2 text-lg">Comprehensive support pillars for sustainable growth.</p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={idx} className="group bg-surface-dark p-8 rounded-xl shadow-sm border border-gray-800 hover:border-primary/50 transition-all hover:shadow-md flex flex-col gap-4">
                ...
                <section className="w-full px-4 lg:px-40 py-16 bg-surface-dark">
                    <div className="max-w-[1280px] w-full mx-auto">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 relative z-10">
                                {[
                                    ...
                                    <div key={idx} className="flex flex-col items-center text-center group">
                                        <div className={`w-16 h-16 rounded-full bg-surface-dark border-4 ${step.opacity} flex items-center justify-center shadow-sm mb-4 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <section className="w-full px-4 lg:px-40 py-16 bg-background-light dark:bg-background-dark">
                    <div className="max-w-[1280px] w-full mx-auto">
                        <div className="flex flex-col lg:flex-row bg-surface-dark rounded-2xl overflow-hidden shadow-sm">
                            ...
                            <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <span className="text-gray-400 text-xs font-medium">Updated 3 days ago</span>
                                </div>
                                <h2 className="hidden lg:block text-white text-3xl font-bold leading-tight mb-4">Cinnamon Producers of Galle</h2>
                                ...
                                <div className="grid grid-cols-2 gap-6 mb-8 border-t border-b border-gray-100 dark:border-white/10 py-6">
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-400">Income Increase</p>
                                    </div>
                                    <div>
                                        <p className="text-4xl font-black text-primary mb-1">500+</p>
                                        <p className="text-sm font-medium text-gray-400">Farmers Certified</p>
                                    </div>
                                </div>
                                <button className="w-fit flex items-center justify-center rounded-lg h-10 px-6 bg-white text-[#111811] text-sm font-bold leading-normal hover:opacity-90 transition-opacity">
