...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen font-sans text-slate-900 dark:text-white">
      ...
      <section className="border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-surface-dark py-10">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale text-2xl font-black text-slate-800 dark:text-white">
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white dark:bg-surface-dark p-8 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 group hover:border-primary/50 transition-colors">
                <div className="mb-4 p-3 bg-primary/10 rounded-lg w-fit text-primary-dark dark:text-primary">
                  {/* Placeholder Icon */}
                  <Leaf className="text-3xl" />
                </div>
                <p className="text-4xl font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary-dark dark:group-hover:text-primary transition-colors">{stat.val}</p>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
            ...
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-6 tracking-tight">What is FNSL?</h2>
      ...
      <section className="py-16 md:py-24 bg-background-light dark:bg-background-dark">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-4">Our Product Categories</h2>
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">Explore the finest ethically sourced produce from the heart of Sri Lanka.</p>
          </div>
          ...
          <div className="mt-12 text-center">
            <Link href="/products" className="inline-flex items-center gap-2 text-slate-900 dark:text-white font-bold hover:text-primary-dark dark:hover:text-primary transition-colors">
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-surface-dark">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-2">Featured Producers</h2>
              <p className="text-lg text-slate-600 dark:text-slate-400">Stories of impact and sustainable farming.</p>
            </div>
            <Link href="/producers" className="hidden md:block text-primary-dark dark:text-primary font-bold hover:underline">View All Producers</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col bg-background-light dark:bg-background-dark rounded-xl overflow-hidden border border-gray-100 dark:border-gray-800">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{producer.name}</h3>
      ...
      <section className="py-16 md:py-24 bg-background-light dark:bg-background-dark">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-12 text-center">Programs & Impact</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              return (
                <div key={i} className="bg-white dark:bg-surface-dark p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  <div className={`size-12 rounded-full bg-${prog.color}-100 dark:bg-${prog.color}-900/30 flex items-center justify-center text-${prog.color}-600 dark:text-${prog.color}-400 mb-4`}>
                    <Icon size={24} />
                  </div>
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{prog.title}</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">{prog.desc}</p>
                </div>
              )
            })}
          </div>
      ...
      <section className="py-16 bg-white dark:bg-surface-dark">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-12">Latest News & Events</h2>
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <Link href="/news/1" className="lg:w-1/2 group cursor-pointer">
              ...
              <div className="flex items-center gap-2 mb-2 text-primary-dark dark:text-primary text-sm font-bold">
                <span>Events</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 group-hover:text-primary-dark dark:group-hover:text-primary transition-colors">Annual Fairtrade Producer Convention 2024</h3>
              <p className="text-slate-600 dark:text-slate-400">Over 500 delegates gathered in Colombo to discuss the future of sustainable agriculture and fair pricing strategies.</p>
            </Link>
            {/* Side Articles List */}
            <div className="lg:w-1/2 flex flex-col gap-6">
              <Link href="/news/2" className="flex gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <h4 className="text-lg font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary-dark dark:group-hover:text-primary transition-colors">New Grant Announced for Organic Certification</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2">FNSL secures funding to help 50 new smallholder groups achieve organic certification status.</p>
                </div>
              </Link>
              ...
              <Link href="/news/3" className="flex gap-4 group cursor-pointer">
                ...
                <div>
                  ...
                  <h4 className="text-lg font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary-dark dark:group-hover:text-primary transition-colors">Partnership with European Retail Giants</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400 line-clamp-2">Expanding the reach of Sri Lankan spices into new supermarkets across Germany and France.</p>
                </div>
              </Link>
            </div>
          </div>
      ...
      <section className="py-16 bg-background-light dark:bg-background-dark">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-2xl md:text-3xl font-medium text-slate-900 dark:text-white mb-8 italic">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="text-left">
              <p className="text-slate-900 dark:text-white font-bold">Rohan Perera</p>
              <p className="text-slate-500 dark:text-slate-400 text-sm">Secretary, Uva Tea Smallholders Association</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-8 md:p-12 bg-white dark:bg-surface-dark rounded-2xl shadow-xl">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-2">Join Our Network</h2>
              <p className="text-slate-600 dark:text-slate-300">Stay updated on the latest Fairtrade news, market trends, and success stories from Sri Lanka.</p>
            </div>
            <div className="md:w-1/2 w-full">
              <form className="flex flex-col sm:flex-row gap-3">
                <input className="flex-1 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-background-dark text-slate-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent outline-none" placeholder="Enter your email address" type="email" />
